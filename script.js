...
(function load(){
    ...
    for(x in students){
        ...
        <i id="edit-btn" onclick="edit(${students[x].ID})" class="fa-solid fa-pen-to-square"> <i onclick="deleteStudent(${students[x].ID})" class="fa-sharp fa-solid fa-trash"></i></td></tr>`
    }
//<i id="edit" onclick="edit()" class="fa-solid fa-pen-to-square">   <img  id="edit-btn" onclick="edit(${students[x].ID})" src="./assest/pencil-svgrepo-com.svg"> 
//<i id="remove" onclick="remove()" class="fa-sharp fa-solid fa-trash"></i> <img onclick="deleteStudent(${students[x].ID})" src="./assest/trash-svgrepo-com.svg">
